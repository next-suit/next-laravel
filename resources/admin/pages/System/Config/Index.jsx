    ...
    return (
        <div>
            ...
            <TableLayout loading={loading} data={list} onChange={() => init()}>
                ...
                <Table.Column flexGrow={1}><Table.HeaderCell>配置键名</Table.HeaderCell><Table.Cell dataKey={'key'}/></Table.Column>
                <Table.Column flexGrow={1}><Table.HeaderCell>配置值类型</Table.HeaderCell><Table.Cell dataKey={'type_name'}/></Table.Column>
                <Table.Column flexGrow={1}><Table.HeaderCell>配置值</Table.HeaderCell><Table.Cell dataKey={'value'}>
                    {row => row.type === 'onoff' ?
                ...
                <Table.Column flexGrow={2}><Table.HeaderCell>提示信息</Table.HeaderCell><Table.Cell dataKey={'tips'}/></Table.Column>
